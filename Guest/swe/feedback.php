...
<body>
	<div class="main">
		<h1 class="w3layouts_head">feedback </h1>
		<div class="w3layouts_main_grid">
			<form action="<?php $_SERVER['PHP_SELF']?>" method="post" class="w3_form_post">
				...
				<div class="w3_agileits_main_grid w3l_main_grid">
					<div class="agileits_grid">
						<h5>feedback </h5>
							<input type="text" name="fb" placeholder="your opinion is important for us" required="">
					</div>
				</div>
				...
				<div class="w3_main_grid">
					...
					<div class="w3_main_grid_right">
						<input type="submit" value="send feedback" name="ff">
					</div>
					<div class="clear"> </div>
				</div>
			</form>
